namespace cloudscribe.FileManager.Web.Models
{
    public class ImageProcessingOptions
    {
        ...
        public string AllowedFileExtensions { get; set; } = ".webp|.gif|.jpg|.jpeg|.svg|.svgz|.png|.flv|.swf|.wmv|.mp3|.mp4|.m4a|.m4v|.oga|.ogv|.aac|.webma|.webmv|.webm|.wav|.fla|.tif|.asf|.asx|.avi|.mov|.mpeg|.mp4|.mpg|.zip|.pdf|.doc|.docx|.xls|.xlsx|.ppt|.pptx|.pps|.csv|.txt|.htm|.html|.css";

        public string ImageFileExtensions { get; set; } = ".webp|.gif|.jpg|.jpeg|.png|.svg|.svgz";

        public string VideoFileExtensions { get; set; } = ".mp4|.webm|.ogv";

        public string AudioFileExtensions { get; set; } = ".mp3|.ogg|.oga|.aac";

        public string AllowedLessPrivilegedFileExtensions { get; set; } = ".webp|.gif|.jpg|.jpeg|.png";
